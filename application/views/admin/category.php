				...
				<div class="modal-dialog">
					<div class="modal-content">
						...
						<div class="modal-body">
							...
							<form class=" form-horizontal " method="post" action="<?= site_url(); ?>/admin_home/add_category">	
								<div class="form-group">
									<label for="inputEmail1" class="col-lg-4 control-label">Category Name</label>
									<div class="col-lg-8">
				...
				<div class="col-lg-3 col-md-3 col-sm-12 col-xs-12">
					<div class="box blue-bg" >
						<div style="float:right;">
							<a href="<?= site_url(); ?>/admin_home/delete_category/<?= $item['category_id']; ?>" title="Delete" style="color: white;">
								<i class="fa fa-trash"  aria-hidden="true"></i>
							</a>
						</div>
						<div class="title"  style="padding-top:20px;">
							<a href="<?= site_url(); ?>/admin_home/sub_category_view/<?= $item['category_id']; ?>" style="color: white;">
								<?= $item['title']; ?>
							</a>
						</div>
					</div>						
